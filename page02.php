            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="page02.php" class="dropdown-item active">Page02</a>
                    </div>
                </li>
            </ul>
...
<div class="m-4">
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="page02.php">Page02</a></li>
      </ol>
    </nav>
</div>

<div class="btn-group">
<a href="#1" class="nav-link"><button type="button" class="btn btn-primary">1</button></a>
<a href="#2"class="nav-link"><button type="button" class="btn btn-success">2</button></a>
<a href="#3"class="nav-link"><button type="button" class="btn btn-danger">3</button></a>
</div>



<div class="m-5"id="1">
<h2><strong>aaaaa</strong></h2>
